...
extra_samplers["distance"] = distance_wrap(resample=2,resample_end=-1,cfgpp=False)
extra_samplers["distance_fast"] = distance_wrap(resample=3,resample_end=1,cfgpp=False)
extra_samplers["distance_cfg_pp"] = distance_wrap(resample=2,resample_end=-1,cfgpp=True)
